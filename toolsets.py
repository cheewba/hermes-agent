...
_HERMES_CORE_TOOLS = [
    ...
    # Browser automation
    "browser_navigate", "browser_set_proxy", "browser_solve_cloudflare", "browser_solve_hcaptcha", "browser_snapshot", "browser_click",
...
TOOLSETS = {
    ...
    "hermes-acp": {
        ...
        "tools": [
            ...
            "vision_analyze",
            "skills_list", "skill_view", "skill_manage",
            "browser_navigate", "browser_set_proxy", "browser_solve_cloudflare", "browser_solve_hcaptcha",
